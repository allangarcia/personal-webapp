  ...
  return (
    <div className="bg-zinc-800">
      <Head>
        ...
        <title>Hi, this is Allan Garcia speaking! - Manifesto</title>
      ...
      <div className="p-5 flex flex-col flex-shrink md:min-h-screen">
        <article className="text-justify">
          ...
          <p className="py-2 text-lg text-sky-500 text-opacity-80 font-mono sm:text-xl">
            The HR recruiter, that doesn&apos;t have any fault in this, takes
            this wave and started to treat experiments or experiences as
            knowledge. An analogous history could exist, imagine a Food Engineer
            that works for Pepsi. Then he/she decides to interview for Coke and
            the question being asked is: &quot;Had you any experience in making
            Coke?&quot;. Of course not. The Engineer is experienced in making
            the beverage, any beverage. No matter the flavor!
          </p>
          <p className="py-2 text-lg text-sky-500 text-opacity-80 font-mono sm:text-xl">
          ...
          <p className="py-2 text-lg text-sky-500 text-opacity-80 font-mono sm:text-xl">
            A Senior Software Engineer didn&apos;t already work with all
            languages that exist, with all frameworks, using all the tools, and
            knowing all the product names that cloud providers invented. AWS RDS
            it&apos;s just a database, GCP Compute it&apos;s just a Virtual
            Machine, and so on. But the job descriptions from today asked about:
            do you know AWS? Do you already program in Rust before? How many
            years are you experienced in the Go language? Are you experienced in
            Flutter? Those are tools!
          </p>
          <p className="py-2 text-lg text-sky-500 text-opacity-80 font-mono sm:text-xl">
            ...
            cloud provider, doesn&apos;t matter the language, or even the
            framework. Doesn&apos;t matter the product name. Maybe, just maybe,
            could be AWS Lambda, but is not required.
          </p>
          <p className="py-2 text-lg text-sky-500 text-opacity-80 font-mono sm:text-xl">
            Because of that reality, and my disagreement about what becomes the
            job descriptions and requirements, also an HR person that
            didn&apos;t understand that requirements. I compile the knowledge
            needed to be a good Senior Software Engineer, into 7 (seven)
            categories, without brands or products. In my opinion, that&apos;s
            what should be into job descriptions. Not languages, frameworks,
            product names, or specific brand tools.
          </p>
          ...
          <p className="py-2 text-lg text-sky-500 text-opacity-80 font-mono sm:text-xl">
            Things communicate! Your phone talks to your friend&apos;s phone via
            a messages app. Your browser access the Google Search. Your tablet
          ...
          <p className="py-2 text-lg text-sky-500 text-opacity-80 font-mono sm:text-xl">
            ...
            package, and what protocol it&apos;s carrying. How this protocol
            carries information from applications. And how different
            applications ran into the same machine without information from one
            application leak to another application. He/she should know about IP
            addresses and carrier protocols like TCP and UDP, and how the
            routing it&apos;s done using those protocols.
          </p>
          <p className="py-2 text-lg text-sky-500 text-opacity-80 font-mono sm:text-xl">
            The heavy lifting that we all rely upon it&apos;s that: carrier
            protocol, like TCP, and routing protocol like IP, work! And the
            payload from an application protocol like HTTP gets from one point
            to another.
          </p>
          <p className="py-2 text-lg text-sky-500 text-opacity-80 font-mono sm:text-xl">
          ...
          <p className="py-2 text-lg text-sky-500 text-opacity-80 font-mono sm:text-xl">
            ...
            for that processor model. That&apos;s the reason we have compilers
            (and interpreters) to translate better readable code, like Python,
            to machine code. In reality, is not that simple, we can have a whole
          ...
          <p className="py-2 text-lg text-sky-500 text-opacity-80 font-mono sm:text-xl">
            Let&apos;s look for instance the recent case of Apple&apos;s using a
            different architecture for their machines, but you can run Python on
            Windows with a CISC processor and also the same Python code on an
            ARM architecture into a macOS machine. This &quot;magic&quot; is
            because some languages are compiled, and some languages are runtime
            interpreted. And doesn&apos;t stop there. Some languages are
            designed to treat data as a dynamic thing, the same variable could
            be a number and later in the program change to a word. Other
            languages have a strong type paradigm and a variable that is first
            declared as a number will be always a number in the program. All of
            these to say that A Senior Software Developer understands all those
            differences and implications from all different languages, even when
            he/she himself/herself did never coded into that language.
          </p>
          <p className="py-2 text-lg text-sky-500 text-opacity-80 font-mono sm:text-xl">
            The important thing to know is that your program will run into a
            process and will be managed by the current operational system,
            it&apos;s not a rogue program doing whatever they want. The
            operational system imposes restrictions like protected memory and
            limited access to other processes and, in some cases, also to the
            filesystem, input-output files, etc., you must know the environment
            that you are in, what comes back to the 1st knowledge that a Senior
          ...
          <p className="py-2 text-lg text-sky-500 text-opacity-80 font-mono sm:text-xl">
            ...
            matter if you are doing &quot;App First&quot;, &quot;Mobile
            First&quot;, &quot;Web First&quot;, or &quot;Desktop First&quot;,
            doesn&apos;t matter. You are communicating with HTTP. Your
            underlying web server just handles a limited number of
            simultaneously connected clients. Your monolithic Full-Stack app
            will not scale. If this is an MVP, it&apos;s ok. But you will have
            to change. And change a lot. The more bad decisions are made, the
            more time you will lose trying to create something unfeasible. And A
          ...
          <p className="py-2 text-lg text-sky-500 text-opacity-80 font-mono sm:text-xl">
            Don&apos;t embrace the corporate culture that CTO is always right
            for the Director, the Director is always right for the Manager, the
            Manager is always right for the Tech Lead, the Tech Lead is always
            right for the Engineer, and the Engineer doesn&apos;t have any
            voice. He/she will leave.
          </p>
          <p className="py-2 text-lg text-sky-500 text-opacity-80 font-mono sm:text-xl">
            ...
            everybody is using. He/she doesn&apos;t convince themself with a
            video presentation, or a showcase on the tech stack promoting page.
            He/she knows what he/she is doing. What the technology provides and
            what is not. Again, listen to your Senior Software Developer, if you
            had one.
          </p>
          <h3 className="py-6 text-2xl text-orange-400 font-semibold md:text-3xl">
          ...
          <p className="py-2 text-lg text-sky-500 text-opacity-80 font-mono sm:text-xl">
            ...
            ones that use less memory, and so on. He/she doesn&apos;t need to
            know already a programming language, those concepts are taught
            before you even code. Coding is a manifestation of that knowledge.
            If a Senior Software Developer knows Swift and Python but
            doesn&apos;t know Rust, this means NOTHING. It only means that
            he/she will learn it in a couple of weeks. Because coding is a
            manifestation of the more profound knowledge, that is computational
            thinking and a problem-solving mindset. And if he/she is a Senior
            Software Developer he/she already used several languages. Any
            language you need he/she is more than capable of learning and using,
            no matter how strange it is, or, apparently difficult.
          </p>
          <p className="py-2 text-lg text-sky-500 text-opacity-80 font-mono sm:text-xl">
          ...
          <p className="py-2 text-lg text-sky-500 text-opacity-80 font-mono sm:text-xl">
            Also, there are alternatives, and I&apos;ll talk about two more,
            block storage and document storage. There is a hype about document
            storage nowadays, everybody seems to want to use a NoSQL database,
            but a NoSQL database is just what the name states, a database that
            is not based on transactions &quot;see-quel&quot; when you INSERT
            things in it, there is no guarantee that the data was stored.
            Eventually, the data will persist, but you don&apos;t know how much
            time after that. It could happen that if you need a piece of data
            just after inserting or updating that data, you will get the old
            response.
          </p>
          <p className="py-2 text-lg text-sky-500 text-opacity-80 font-mono sm:text-xl">
          ...
          <p className="py-2 text-lg text-sky-500 text-opacity-80 font-mono sm:text-xl">
            ...
            databases (that are just files), persistency, or even a
            &quot;memory&quot; of you favorite language, is ultimately stored
            into blocks. It&apos;s easier to store data into blocks and access
            them later using a map. Imagine having to read the whole disk every
            time we need a file? Of reading through a whole database to find the
            payment data? We make maps and index things. We look into those
            indexes like a reader looking into a summary page from his/her
            favorite book to remember which page has his/her favorite quote.
            This summary has the important blocks where data are stored, then we
            jump there.
          </p>
          <h3 className="py-6 text-2xl text-orange-400 font-semibold md:text-3xl">
          ...
          <p className="py-2 text-lg text-sky-500 text-opacity-80 font-mono sm:text-xl">
            RUP is garbage, nobody uses it anymore, it&apos;s just like you say
            that you are starting your engine with a crank. Never worked and
            never will. Companies use it because if you say that you are using
            it you look cool.
          </p>
          <p className="py-2 text-lg text-sky-500 text-opacity-80 font-mono sm:text-xl">
            ...
            ask him/her. Make a list. You don&apos;t need sticky person drawings
            for your project.
          </p>
          <p className="py-2 text-lg text-sky-500 text-opacity-80 font-mono sm:text-xl">
          ...
          <p className="py-2 text-lg text-sky-500 text-opacity-80 font-mono sm:text-xl">
            ...
            Software Engineer knows when a Scrum Ceremony isn&apos;t needed. And
            when it does.
          </p>
          <p className="py-2 text-lg text-sky-500 text-opacity-80 font-mono sm:text-xl">
